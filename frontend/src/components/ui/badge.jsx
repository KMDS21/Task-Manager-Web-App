  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        rejected: "border-transparent bg-rose-500/15 text-rose-600 dark:text-rose-400 border-rose-500/20",
        super_admin: "border-transparent bg-rose-600/15 text-rose-700 dark:text-rose-300 border-rose-600/20 font-bold",
        admin: "border-transparent bg-purple-500/15 text-purple-600 dark:text-purple-400 border-purple-500/20",
        employee: "border-transparent bg-slate-500/15 text-slate-600 dark:text-slate-400 border-slate-500/20",
